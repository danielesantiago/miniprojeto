...
<head>
    ...
    <script src="ajaxhandler.js"></script> <!-- Incluindo o script AJAX -->
    <script>
        // Chama a função atualizarLances quando a página for carregada
    ...
    <div id="container">
        ...
        <section id="usuario">
            ...
            <form id="inserirLance" method="post">
                ...
                <button type="submit" onclick="enviarLance(event)">Fazer Lance</button>
            </form>
        </section>
